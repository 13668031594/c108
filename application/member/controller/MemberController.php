...
class MemberController extends AdminController
{
    ...
    public function getIndex()
    {
        ...
        //视图
        return parent::view('index', ['grade' => $grade, 'grades' => json_encode($grade)]);
    }
    ...
    {
        $grade = $this->class->member->grades;

        $lock = $this->class->member->locks;

        $bank = $this->class->bank();

        //视图
        return parent::view('member', ['grade' => $grade, 'lock' => $lock, 'bank' => $bank]);
    }
    ...
    public function getEdit(Request $request)
    {
        ...
        //视图
        return parent::view('member', ['self' => $member, 'grade' => $grade, 'lock' => $lock, 'bank' => $bank]);
    }
    ...
    public function getWallet(Request $request)
    {
        ...
        $result = [
            'self' => $member,
            'status' => $this->class->member->statuses,
            'grade' => $this->class->member->grades,
        ];
