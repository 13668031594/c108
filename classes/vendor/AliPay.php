...
class AliPay extends FirstClass
{
    ...
    public function pay($param = [])
    {
        ...
        $aop->appId = $this->set['appId'];
        $aop->rsaPrivateKey = $this->set['rsaPrivateKey'];
